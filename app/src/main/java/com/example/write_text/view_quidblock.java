...
public class view_quidblock extends AppCompatActivity implements SensorEventListener {
    SensorManager sm;
    Boolean test1 = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (found != null) {
            ...
            ADJUSTMENT();
            ROTATE = new QUAIDBLOCK(getApplicationContext());
    ...
    private void AR_PHASE() {
        ...
        boolean sd = AR.SET_AR_FILE_PATH("//storage//9887-2D8C//VrVideo//QUIADBLOCK//quiadblock.txt");
