...
public class view_civil extends AppCompatActivity implements SensorEventListener {
    SensorManager sm;
    Boolean test1 = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (found != null) {
            ...
            ADJUSTMENT();
            ROTATE = new CIVIALBLOCK(getApplicationContext());
    ...
    private void AR_PHASE() {
        ...
        boolean sd = AR.SET_AR_FILE_PATH("//storage//9887-2D8C//VrVideo//CIVIALBLOCK//civialblock.txt");
    ...
    private void SHOW_IMAGE_PROCEDURE() {
        ...
        image_detail = ROTATE.forward_path.get("FRONT_CIVIALBLOCK1.jpeg");
        ROTATE.forward = true;
        turn = true;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (event.sensor == mAccelerometer && set) {
            ...
            if (event.values[0] > 4 && event.values[2] < 2) {

                if (ROTATE.forward) {

                    if (image_detail.forwarda_path) {
                        if (Degress < front_bound + 5 && Degress > front_bound - 5) {
                            test1 = true;
                        }
                    } else if (image_detail.forward_left_Any_path) {

                        if (Degress < left_bound + 5 && Degress > left_bound - 5) {
                            test1 = true;
                        ...
                        if (Degress < right_bound + 5 && Degress > right_bound - 5) {
                            test1 = true;
                        }
            ...
            if (event.values[2] > 2 && event.values[0] < 6) {
