...
public class view extends AppCompatActivity implements SensorEventListener {
    SensorManager sm;
    Boolean test1 = false ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(found!=null)
        {
                ...
                AR_PHASE();
                ADJUSTMENT();
                ROTATE = new CSFACULTY(getApplicationContext());
        }
        else
        {
    ...
    private void AR_PHASE()
    {
         ...
         boolean sd = AR.SET_AR_FILE_PATH("//storage//9887-2D8C//VrVideo//CSFACULTY//csfaculty.txt");
    ...
    private void SHOW_IMAGE_PROCEDURE()
    {
                    ...
                    image_detail = ROTATE.forward_path.get("FRONT_CS_FACULTY1.jpg");
                    ROTATE.forward =  true ;
                    turn = true ;
    ...
    public void onSensorChanged(SensorEvent event)
    {
        ...
        if (event.sensor == mAccelerometer  && set)
        {
            ...
            if(event.values[0]>2 && event.values[2]<1)
            {
                        ...
                        if(ROTATE.forward)
                        {
                                   ...
                                   {
                                       if (Degress < front_bound + 9 && Degress > front_bound - 9)
                                       {
                                           test1 = true;
                                       }
                                   }
                                   else if(image_detail.forward_left_Any_path)
                                   {
                                       ...
                                       if (Degress < left_bound + 9 && Degress > left_bound - 9)
                                       {
                                           test1 = true;
                                   ...
                                   else if(image_detail.forward_right_Any_path)
                                   {
                                       ...
                                       if (Degress < right_bound + 9 && Degress > right_bound - 9)
                                       {
                                           test1 = true;
                                       }
                                            ...
                                            if (image_detail.backward_path)
                                            {
                                                if (Degress < front_bound + 9 && Degress > front_bound - 9)
                                                {
                                                    if (test1)
                                                    {
                                                        ...
                                                        System.out.println("CALL 1"+image_detail.name);
    ...
    private void IMAGE_CHANGE(String imagepath)
    { // bit = null;
