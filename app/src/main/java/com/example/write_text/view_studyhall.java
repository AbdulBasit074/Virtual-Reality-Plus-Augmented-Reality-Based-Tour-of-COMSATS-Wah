...
public class view_studyhall extends AppCompatActivity implements SensorEventListener {
    SensorManager sm;
    Boolean test1 = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (found != null) {
            ...
            ADJUSTMENT();
            ROTATE = new STUDYHALL(getApplicationContext());
    ...
    private void AR_PHASE() {
        ...
        boolean sd = AR.SET_AR_FILE_PATH("//storage//9887-2D8C//VrVideo//STUDYHALL//studyhall.txt");
    ...
    private void SHOW_IMAGE_PROCEDURE() {
        ...
        image_detail = ROTATE.forward_path.get("FRONT_STUDYHALL1.jpeg");
        ROTATE.forward = true;
        turn = true;
